...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "الرمز المثالي للاستشارات المالية والإدارية | Al Ramz Al Methaly" },
      ...
      { property: "og:image", content: "https://alramzalmethaly.com/logo.png" },
      { name: "twitter:image", content: "https://alramzalmethaly.com/logo.png" },
    ],
    links: [
